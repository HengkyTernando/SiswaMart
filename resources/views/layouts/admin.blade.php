...
<head>
    ...
    <title>@yield('title', 'Admin') | SiswaMart</title>
...
<body class="flex min-h-screen">
    ...
    <aside class="app-sidebar hidden lg:flex">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            ...
            <div class="sidebar-section-title mt-4">Manajemen</div>
        ...
        <div class="p-4 border-t border-[var(--border-color)] flex-shrink-0">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-xs capitalize">Admin SiswaMart</p>
                </div>
            </div>
        ...
        <header class="app-topbar">
            <div class="flex items-center gap-3 w-full mx-auto">
                ...
                <div class="flex-1 min-w-0">
                    <h1 class="font-display font-semibold text-lg text-[var(--text-main)] truncate">@yield('page-title', 'Admin Panel')</h1>
                </div>
