...
<div class="max-w-xl mx-auto px-4 py-10">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-black text-gray-900 mt-2">Tambah Kategori</h1>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-gray-50 resize-none">{{ old('description') }}</textarea>
            </div>
