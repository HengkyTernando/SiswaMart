...
<div class="max-w-xl mx-auto px-4 py-10">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-black text-white mt-2">Edit Kategori</h1>
    </div>
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="input-dark w-full border rounded-xl px-4 py-3 text-sm transition resize-none">{{ old('description', $category->description) }}</textarea>
            </div>
