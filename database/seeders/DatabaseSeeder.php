...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products_data = [
            // Alat Tulis (cat 0)
            ['cat' => 0, 'seller' => $seller1, 'name' => 'Pensil 2B Faber Castell (12 pcs)', 'price' => 25000,  'stock' => 150, 'desc' => 'Pensil gambar berkualitas tinggi untuk sketsa dan tulis.',   'img' => 'https://picsum.photos/seed/pencil1/400/400'],
            ['cat' => 0, 'seller' => $seller1, 'name' => 'Pulpen Pilot G2 Hitam',            'price' => 15000,  'stock' => 200, 'desc' => 'Pulpen gel halus anti bocor, tinta hitam tahan lama.',      'img' => 'https://picsum.photos/seed/pen2/400/400'],
            ...
            ['cat' => 0, 'seller' => $seller1, 'name' => 'Stabilo Boss Highlight 6 Warna',   'price' => 32000,  'stock' => 120, 'desc' => 'Stabilo warna-warni untuk menandai catatan penting.',     'img' => 'https://picsum.photos/seed/stabilo4/400/400'],
            // Buku (cat 1)
            ...
            ['cat' => 1, 'seller' => $seller1, 'name' => 'Kamus Bahasa Inggris Lengkap',     'price' => 120000, 'stock' => 40,  'desc' => 'Kamus lengkap Inggris-Indonesia lebih dari 50.000 kata.', 'img' => 'https://picsum.photos/seed/dict7/400/400'],
            // Tas (cat 2)
            ['cat' => 2, 'seller' => $seller1, 'name' => 'Tas Ransel Sekolah Besar 35L',     'price' => 180000, 'stock' => 60,  'desc' => 'Tas ransel ergonomis anti air kapasitas besar.',         'img' => 'https://picsum.photos/seed/bag8/400/400'],
            ...
            // Elektronik (cat 3)
            ['cat' => 3, 'seller' => $seller1, 'name' => 'Kalkulator Casio FX-991ES',        'price' => 210000, 'stock' => 35,  'desc' => 'Kalkulator scientific 417 fungsi, layar besar.',          'img' => 'https://picsum.photos/seed/calc10/400/400'],
            ...
            // Seragam (cat 4)
            ['cat' => 4, 'seller' => $seller1, 'name' => 'Seragam Putih Abu-abu SMP Set',   'price' => 145000, 'stock' => 70,  'desc' => 'Seragam lengkap baju putih dan celana/rok abu-abu.',      'img' => 'https://picsum.photos/seed/uniform12/400/400'],
            // Olahraga (cat 5)
